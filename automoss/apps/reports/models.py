...
class MOSSReport(models.Model):
    ...
    job = models.OneToOneField(Job, on_delete=models.CASCADE, limit_choices_to={'status': COMPLETED_STATUS})
...
class GeneratedReport(models.Model):
    ...
    report_id = models.CharField(primary_key=False, default=uuid.uuid4, max_length=UUID_LENGTH, unique=True, editable=False)
